  ...
  return (
    ...
    >
      ...
      <div className="flex-auto flex items-center justify-start">
        ...
        />
        <Button variant="ghost" size="icon" className="hover:bg-inherit hover:text-muted-foreground">
          <CornerDownLeft size={24} />
        </Button>
      </div>
      <div className="ml-6 opacity-50">
        <Button variant="ghost" className="p-2 hover:bg-inherit hover:text-muted-foreground">
          续写
